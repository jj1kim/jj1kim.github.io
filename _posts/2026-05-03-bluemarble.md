...
2번 규칙은 모바일, linux pc, mac pc, window pc 등 운영체제뿐만 아니라, 기기의 성능이 좀 떨어지더라도 누구나 게임을 즐길 수 있게 하려고 수립했습니다. 최근에 유행하는 모 SNS 앱이 ios 유저만 사용 가능했던지라, 적잖이 아쉬움을 느꼈고, 이를 반면교사 삼았습니다.
